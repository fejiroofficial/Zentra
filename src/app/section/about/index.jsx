  ...
  return (
    <div className="container mx-auto text-black py-16">
      ...
      <TagLabel text="About Zentra" />
        ...
        <h2 className="text-[36px] md:text-[48px] font-semibold">What does Zentra do?</h2>
        ...
        <div className="flex flex-col md:flex-row justify-between gap-10 mt-8">
          <div className="max-w-xl text-left space-y-6">
            ...
            <h4 className="text-[16px] md:text-[18px] text-gray-700">
    ...
    <div >
          ...
          <div className="max-w-sm">
            <Image src={image} alt="About Zentra illustration" className="w-[490px] h-[550px]"/>
          </div>
        </div>
